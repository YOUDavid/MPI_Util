...
void mpi_init(){
    ...
    /*WTHREAD_COMM = malloc(sizeof(MPI_Comm) * NUM_OF_WTHREADS * WORLD_SIZE);
    for (i = 0; i < NUM_OF_WTHREADS * WORLD_SIZE; ++i){
    ...
    if (WORLD_RANK != 0){
        ...
        while (signal >= 0){
            switch (signal){
/*                case SIGNAL_LDGEMM:*/
/*                    mpi_ldgemm(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,*/
